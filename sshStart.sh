...
mkdir -p /home/$1/tomcat && cp -a $tomcat/. /home/$1/tomcat/ && sleep 2 && rm -R /home/$1/tomcat/logs/* && /home/$1/tomcat/bin/startup.sh
ssh $1@$3 "mkdir -p /home/$1/tomcat && cp -a $tomcat/. /home/$1/tomcat/ && sleep 2 && rm -R /home/$1/tomcat/logs/* && JRE_HOME=/opt/jdk1.8.0_60 /home/$1/tomcat/bin/startup.sh &"
ssh $1@$4 "mkdir -p /home/$1/tomcat && cp -a $tomcat/. /home/$1/tomcat/ && sleep 2 && rm -R /home/$1/tomcat/logs/* && JRE_HOME=/opt/jdk1.8.0_60 /home/$1/tomcat/bin/startup.sh &"
