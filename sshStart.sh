...
ssh $1@$3 mkdir /home/$1/tomcat && cp -a $tomcat/. /home/$1/tomcat/ && "$tomcat/bin/shutdown.sh" && sleep 5 && "$tomcat/bin/startup.sh"
ssh $1@$4 mkdir /home/$1/tomcat && cp -a $tomcat/. /home/$1/tomcat/ && "$tomcat/bin/shutdown.sh" && sleep 5 && "$tomcat/bin/startup.sh"
