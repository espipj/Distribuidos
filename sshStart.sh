...
ssh $1@$3 mkdir /home/$1/tomcat && cp -a $tomcat/. /home/$1/tomcat/ && "/home/$1/tomcat/bin/shutdown.sh" && sleep 5 && "/home/$1/bin/startup.sh"
ssh $1@$4 mkdir /home/$1/tomcat && cp -a $tomcat/. /home/$1/tomcat/ && "/home/$1/tomcat/bin/shutdown.sh" && sleep 5 && "/home/$1/bin/startup.sh"
